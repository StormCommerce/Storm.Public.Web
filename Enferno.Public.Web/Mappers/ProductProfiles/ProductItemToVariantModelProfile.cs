...
namespace Enferno.Public.Web.Mappers.ProductProfiles
{
    ...
    {
        public ProductItemToVariantModelProfile()
        {
            CreateMap<ProductItem, VariantModel>()
                ...
                .ForMember(to => to.Price, opts => opts.ResolveUsing<ProductItemPriceResolver<VariantModel>>())
                .ForMember(to => to.Flags, opts => opts.ResolveUsing<ProductItemVariantFlagsResolver<VariantModel>>())
                ...
                .ForMember(to => to.OnHandStatus, opts => opts.ResolveUsing<ProductItemOnHandStatusResolver<VariantModel>>())
