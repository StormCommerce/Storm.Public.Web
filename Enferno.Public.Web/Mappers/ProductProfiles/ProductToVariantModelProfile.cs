...
namespace Enferno.Public.Web.Mappers.ProductProfiles
{
    ...
    {
        public ProductToVariantModelProfile()
        {
            CreateMap<Product, VariantModel>()
                ...
                .ForMember(to => to.Price, opts => opts.ResolveUsing<ProductPriceResolver<VariantModel>>())
                .ForMember(to => to.Flags, opts => opts.ResolveUsing<ProductFlagsResolver<VariantModel>>())
                ...
                .ForMember(to => to.OnHandStatus, opts => opts.ResolveUsing<ProductOnHandStatusResolver<VariantModel>>())
